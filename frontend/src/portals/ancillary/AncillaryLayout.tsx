...
const ancillaryNav: NavItem[] = [
  ...
  { section: 'Library Management', label: 'Library Dashboard', icon: 'fas fa-book', to: '/ancillary/library/dashboard', requiredSecondaryRoles: ['Library Assistant', 'Librarian'] },
  { label: 'Book Catalog', icon: 'fas fa-book-open', to: '/ancillary/library/books', requiredSecondaryRoles: ['Library Assistant', 'Librarian'] },
  { label: 'Active Loans', icon: 'fas fa-handshake', to: '/ancillary/library/loans', requiredSecondaryRoles: ['Library Assistant', 'Librarian'] },
  { label: 'Overdue Books', icon: 'fas fa-exclamation-circle', to: '/ancillary/library/overdue', requiredSecondaryRoles: ['Library Assistant', 'Librarian'] },
  { label: 'Reservations', icon: 'fas fa-bookmark', to: '/ancillary/library/reservations', requiredSecondaryRoles: ['Library Assistant', 'Librarian'] },
  { label: 'Library Reports', icon: 'fas fa-chart-bar', to: '/ancillary/library/reports', requiredSecondaryRoles: ['Library Assistant', 'Librarian'] },
