  ...
  return (
    <>
      ...
      <div className="portal-stats-grid">
        <div className="portal-stat-card"><div className="portal-stat-icon green"><i className="fas fa-hand-holding-heart"></i></div><div className="portal-stat-info"><h3>{formatCurrency(12450)}</h3><p>Raised This Year</p></div></div>
