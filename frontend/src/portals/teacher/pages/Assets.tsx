...
export default function TeacherAssets() {
  ...
  const [incidentForm, setIncidentForm] = useState({ issueType: 'fault', details: '' });
  ...
  const handleReportIncident = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setIncidentForm({ issueType: 'fault', details: '' });
      fetchAssets();
    } catch (err) {
  ...
  return (
    <>
      <div className="portal-page-header">
        ...
        <p>View school equipment and register assets assigned to your department.</p>
      </div>

      <div className="portal-card">
        <div className="portal-card-header">
          <h2><i className="fas fa-boxes" style={{ marginRight: 8, color: 'var(--school-primary, #3182ce)' }}></i>Asset Register</h2>
          ...
          {loading ? (
            ...
            <table className="portal-table">
              ...
              <tbody>
                ...
                {assets.length === 0 && (
                    <tr><td colSpan={6} style={{ textAlign: 'center', padding: 30, color: '#a0aec0' }}>No assets registered yet.</td></tr>
                )}
              </tbody>
            </table>
          )}
              ...
              <div className="portal-modal-card" style={{ maxWidth: 600 }}>
                  ...
                  <form onSubmit={async (e: any) => {
                      ...
                      <div className="portal-modal-footer">
                          ...
                          <button type="submit" className="portal-btn-primary">Save Asset</button>
                      </div>
                  </form>
              </div>
          </div>
