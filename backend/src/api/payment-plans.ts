...
router.post('/', requireAuth, requireRole('PARENT'), async (req: AuthRequest, res: Response) => {
  try {
...
router.get('/my', requireAuth, requireRole('PARENT'), async (req: AuthRequest, res: Response) => {
  try {
