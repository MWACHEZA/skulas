...
export async function generateAcademicReportPDF(data: ReportData, res: Response) {
  ...
  doc.fillColor('#4a5568').font('Helvetica-Oblique').fontSize(9).text(
    isMedical 
    ...
    : "The student has shown steady progress this term. Continued focus on core subjects will ensure excellent results in final examinations.",
    60, doc.y + 15, { width: 480 }
  );
