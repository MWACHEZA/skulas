...
exports.BulkGradeSchema = zod_1.z.object({
    body: zod_1.z.object({
        ...
        classAverage: zod_1.z.number().optional(),
        results: zod_1.z.array(zod_1.z.object({
            studentId: zod_1.z.string().min(1, 'Student ID is required'),
            caScore: zod_1.z.union([zod_1.z.number(), zod_1.z.string()]).optional().default(0),
            examScore: zod_1.z.union([zod_1.z.number(), zod_1.z.string()]).optional().default(0),
            score: zod_1.z.number().optional(),
            grade: zod_1.z.string().optional(),
            comment: zod_1.z.string().optional().nullable(),
            assessmentEntries: zod_1.z.any().optional(),
            classAverage: zod_1.z.number().optional(),
            classPosition: zod_1.z.number().optional(),
