...
async function main() {
    ...
    // ─── Grades ───────────────────────────────────────────────────────
    const gradeMap = { 90: 'A', 80: 'B+', 70: 'B', 60: 'C', 50: 'D' };
    ...
    console.log('\n📋 Test Credentials (School Code: AX-EMBAKWE):');
    console.log('  Admin:    admin@embakwehigh.edu.zw / Admin@1234');
    console.log('  Bursar:   bursar@embakwehigh.edu.zw / Bursar@1234');
    console.log('  Library:  library@embakwehigh.edu.zw / Library@1234');
