...
const hash = (pw) => bcryptjs_1.default.hash(pw, 10);
async function seedUsers(prisma, school, emailPrefix) {
    ...
    const studentUsers = Array.from({ length: 30 }).map((_, i) => {
        ...
        let secondaryRoles = [];
        if (num === 1)
            secondaryRoles = ['Head Girl'];
        else if (num === 2)
            secondaryRoles = ['Head Boy'];
        else if (num === 3)
            secondaryRoles = ['Prefect', 'Sports Captain'];
        else if (num === 4)
            secondaryRoles = ['Senior Prefect'];
        else if (num === 5)
            secondaryRoles = ['Class Monitor'];
        else if (num === 6)
            secondaryRoles = ['House Captain'];
        else if (num === 7)
            secondaryRoles = ['Church Prefect'];
        else if (num === 8)
            secondaryRoles = ['Student Librarian'];
        return {
