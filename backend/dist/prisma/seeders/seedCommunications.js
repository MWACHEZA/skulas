...
exports.seedCommunications = seedCommunications;
async function seedCommunications(prisma, school) {
    ...
    if (!dept)
        dept = await prisma.department.create({ data: { name: 'HR', schoolId: school.id } });
    if (admin) {
        for (let i = 0; i < 10; i++) {
...
//# sourceMappingURL=seedCommunications.js.map